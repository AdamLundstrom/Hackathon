    ...
    <nav class="navbar navbar-default navigation-clean-button">
        <div class="container">
            ...
            <div
                ...
                <p class="navbar-text navbar-right actions" data-bs-hover-animate="bounce"><a class="navbar-link login" href="login.php" data-bs-hover-animate="bounce" style="font-family:'Bad Script', cursive;font-weight:bold;font-size:18px;font-style:normal;color:#22282d;">Logga in</a> <a class="btn btn-default action-button"
